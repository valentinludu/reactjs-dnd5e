...
const CharacterPreview = () => {
  ...
  const { data: subclassNameData, isLoading: subclassesNamesLoading } =
    useQuery(
  ...
  const { data: classesSpellsData, isLoading: spellsLoading } = useQuery(
    [
  ...
  const { data: sublcassesData, isLoading: subclassesLoading } = useQuery(
    [
